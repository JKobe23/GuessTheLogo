...
public class MainActivityNeutral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn3 = (Button) findViewById(R.id.neubtn3);
        btn4 = (Button) findViewById(R.id.neubtn4);
        txt = (TextView) findViewById(R.id.neutralScore);
